...
public class SalutationController extends ImsServiceTemplate<Salutation, SalutationRepository>{
	...
	@Override
	@PreAuthorize("hasRole('SUPERADMIN')")
	public Salutation create(@Valid @RequestBody Salutation t) {
		// TODO Auto-generated method stub
	...
	@Override
	@PreAuthorize("hasRole('SUPERADMIN')")
	public List<Salutation> createAll(@Valid @RequestBody  List<Salutation> t) {
		// TODO Auto-generated method stub
	...
	@Override
	@PreAuthorize("hasRole('SUPERADMIN')")
	public ImsResponse update(@Valid @RequestBody Salutation t) {
		// TODO Auto-generated method stub
