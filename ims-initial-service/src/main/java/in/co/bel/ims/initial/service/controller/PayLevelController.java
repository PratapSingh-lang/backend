...
@RestController@CrossOrigin
@RequestMapping("/app/payLevel")
public class PayLevelController extends ImsServiceTemplate<PayLevel, PayLevelRepository>{
	...
	@Override
	@PreAuthorize("hasRole('SUPERADMIN')")
	public PayLevel create(@Valid @RequestBody PayLevel t) {
		// TODO Auto-generated method stub
	...
	@Override
	@PreAuthorize("hasRole('SUPERADMIN')")
	public List<PayLevel> createAll(@Valid @RequestBody  List<PayLevel> t) {
		// TODO Auto-generated method stub
	...
	@Override
	@PreAuthorize("hasRole('SUPERADMIN')")
	public ImsResponse update(@Valid @RequestBody PayLevel t) {
		// TODO Auto-generated method stub
