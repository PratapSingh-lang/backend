...
import in.co.bel.ims.initial.data.repository.VenueRepository;
import in.co.bel.ims.initial.entity.Venue;
import in.co.bel.ims.initial.service.dto.ImsResponse;
import in.co.bel.ims.initial.service.fwk.ImsServiceTemplate;

@RestController@CrossOrigin
@RequestMapping("/app/venue")
public class VenueController extends ImsServiceTemplate<Venue, VenueRepository>{
	...
	@Override
	@PreAuthorize("hasRole('SUPERADMIN')")
	public Venue create(@Valid @RequestBody Venue t) {
		// TODO Auto-generated method stub
	...
	@Override
	@PreAuthorize("hasRole('SUPERADMIN')")
	public List<Venue> createAll(@Valid @RequestBody  List<Venue> t) {
		// TODO Auto-generated method stub
	...
	@Override
	@PreAuthorize("hasRole('SUPERADMIN')")
	public ImsResponse update(@Valid @RequestBody Venue t) {
		// TODO Auto-generated method stub
